    ...
    <div class="components-container-editor" ref="container">
        <div class="content">
            ...
            <div class="right">
                ...
                <br/>
                <el-button style="margin-bottom: 10px" :disabled="!!this.mapPOP.length" size="small" type="danger" @click.stop="save">保存公文
                </el-button>
                <br/>
...
<script>
    import {getByPath, getsuggestWord, wordformat, getmistakewordHtml, reviseToWord, getByWord, saveWord} from '@/api/fileupload'
